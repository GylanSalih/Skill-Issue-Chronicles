...
function AxeIcon() {
  return (
    <svg
      ...
      focusable='false'
    >
      <path d='M43 8l9 8-7 7-9-8z' fill='#c7a27a' />
      <path d='M45 10l6 5-3 3-6-5z' fill='#8b5e3c' />
      <rect x='10' y='30' width='10' height='24' rx='3' fill='#a05a2c' />
      <path d='M20 32L44 9l9 8-25 22z' fill='#d0d5db' />
      <path d='M44 9l9 8-3 3-9-8z' fill='#9aa3af' />
    </svg>
  );
}
