        ...
        <div className={`${styles.section} ${styles.vendorSection}`}>
          ...
          <div className={styles.vendorContainer}>
            ...
            <div className={styles.vendorInfo}>
              ...
              <p>"Willkommen in meinem Laden! Ich habe die besten Waren der Stadt."</p>
                ...
                <div key={item.id} className={styles.itemCard}>
                  ...
                  <div className={styles.itemActions}>
                    <div className={styles.quantitySelector}>
                      <button 
                        onClick={() => updateQuantity(item.id, (selectedQuantity[item.id] || 1) - 1)}
                    ...
                    <button 
                      ...
                      disabled={playerGold < (item.price * (selectedQuantity[item.id] || 1))}
                    >
                      Kaufen ({(item.price * (selectedQuantity[item.id] || 1)).toLocaleString()} Gold)
                    </button>
                  </div>
                </div>
              ))}
                ...
                <div key={item.id} className={styles.itemCard}>
                  ...
                  <div className={styles.itemStats}>
                    <div className={styles.statRow}>
                      ...
                      <span className={styles.sellPrice}>{item.sellPrice} Gold</span>
                    </div>
                    <div className={styles.statRow}>
                      <span>Anzahl:</span>
                      <span>{item.quantity}</span>
                  ...
                  <div className={styles.itemActions}>
                    ...
                    >
                      Verkaufen ({(item.sellPrice * (selectedQuantity[item.id] || 1)).toLocaleString()} Gold)
                    </button>
                  </div>
                </div>
              ))}
