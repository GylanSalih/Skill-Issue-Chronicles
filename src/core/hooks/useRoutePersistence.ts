...
const PATH_TO_MENU_ID: Record<string, string> = {
  ...
  '/character/profile': 'profile-profile',
  '/character/inventory': 'profile-inventory',
  '/character/skins': 'profile-skins',
  '/character/badges': 'profile-badges',
  '/character/uistuffrandom': 'profile-uistuffrandom',
  '/dungeon': 'dungeon',
...
const MENU_ID_TO_CATEGORY: Record<string, string> = {
  ...
  'profile-skins': 'profile',
  'profile-badges': 'profile',
  'profile-uistuffrandom': 'profile',
  dungeon: 'combat',
  'boss-tower': 'combat',
  slayer: 'combat',
  pvp: 'combat',
