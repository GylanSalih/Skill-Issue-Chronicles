    ...
    <div className={styles.myPets}>
      ...
      <div className={styles.scenerySection}>
        ...
        <div className={styles.sceneryDescription}>
          <h2>Pet Sanctuary</h2>
          <p>
            Welcome to your personal pet sanctuary! Here you can manage your
            collection of magical creatures, train them for battle, and watch
            them grow stronger. Each pet has unique abilities and can be trained
            to become a powerful companion in your adventures.
          </p>
        </div>
      </div>
            ...
            {selectedPet ? (
              <div className={styles.petDetails}>
                ...
                <div className={styles.petDetailInfo}>
                  ...
                  <div className={styles.petDetailType}>
                    {selectedPet.type} • {selectedPet.element}
                  </div>
                </div>
