    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Your idle adventure begins here. Start by activating skills to
          generate resources!
        </p>
      </div>
        ...
        <div className={styles.skillsGrid}>
          {Object.values(gameState.skills).map(skill => {
            ...
            return (
              ...
              >
                <div className={styles.skillIcon}>{getSkillIcon(skill.id)}</div>
      ...
      <div className={styles.statsGrid}>
        ...
        <div className={styles.statCard}>
          ...
          <div className={styles.statContent}>
            ...
            <p className={styles.statValue}>
              {
                Object.values(gameState.skills).filter(skill => skill.isActive)
                  .length
              }
            </p>
          </div>
        ...
        <div className={styles.statCard}>
          ...
          <div className={styles.statContent}>
            ...
            <p className={styles.statValue}>
              {Object.values(gameState.resources.secondary).reduce(
                (sum, val) => sum + val,
                0
              )}
            </p>
