...
import {
  ...
  type Boss,
  type TowerFloor,
} from '../../../core/services/bossConfig';
import { useBossCombat } from '../../../core/hooks/useBossCombat';
...
const BossTower: React.FC = () => {
  ...
  useEffect(() => {
    if (combatState.isVictory && selectedBoss) {
      const currentFloorData = towerFloors.find(
        floor => floor.boss.id === selectedBoss.id
      );
      if (currentFloorData) {
    ...
    <div className={styles.bossTower}>
      ...
      <div className={styles.scenerySection}>
        ...
        <div className={styles.sceneryDescription}>
          ...
          <p>
            Welcome to the legendary Boss Tower, a mystical structure that
            reaches into the clouds. Each floor houses a powerful boss that must
            be defeated to progress higher. The tower tests your strength,
            strategy, and determination. Only the most skilled warriors can
                ...
                >
                  ...
                  <div className={styles.bossPreview}>
                    <div className={styles.bossAvatar}>
                      ...
                      <div
                        ...
                        style={{
                          backgroundColor: getBossRarityColor(
                            floor.boss.rarity
                          ),
                    ...
                    <div className={styles.bossInfo}>
                      ...
                      <p className={styles.bossType}>
                        Level {floor.boss.level} {floor.boss.type}
                      </p>
                  ...
                  <div className={styles.floorInfo}>
                    ...
                    <div
                      ...
                      style={{
                        backgroundColor: getDifficultyColor(floor.difficulty),
                      }}
                    >
                      {floor.difficulty}
                    </div>
        ...
        <div className={styles.combatArena}>
          <div className={styles.combatHeader}>
            ...
            {combatState.isVictory && (
              <div className={styles.victoryMessage}>🎉 VICTORY! 🎉</div>
            )}
            {combatState.isDefeat && (
              <div className={styles.defeatMessage}>💀 DEFEAT! 💀</div>
            )}
            <button className={styles.fleeButton} onClick={handleFleeCombat}>
              Flee Battle
            </button>
          </div>
              ...
              <div className={styles.combatantCard}>
                <div className={styles.combatAvatar}>
                  ...
                  <div
                    className={styles.rarityBadge}
                    style={{
                      backgroundColor: getBossRarityColor(player.rarity),
                ...
                <div className={styles.combatInfo}>
                  ...
                  <div className={styles.healthBar}>
                    ...
                    <span className={styles.healthText}>
                      {combatState.playerHealth}/{player.maxHealth}
                    </span>
                  </div>
                  <div className={styles.manaBar}>
                    ...
                    <span className={styles.manaText}>
                      {combatState.playerMana}/{player.maxMana}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.combatant}>
              <div className={styles.combatantCard}>
                ...
                <div className={styles.combatInfo}>
                  ...
                  <p className={styles.combatLevel}>
                    Level {selectedBoss?.level} {selectedBoss?.type}
                  </p>
                  <div className={styles.healthBar}>
                    <div
                      className={styles.healthFill}
                    ...
                    />
                    <span className={styles.healthText}>
                      {combatState.bossHealth}/{selectedBoss?.maxHealth}
                    </span>
                  </div>
                </div>
              </div>
          ...
          {selectedBoss && (
            <div className={styles.bossDescription}>
              <h4>
                {selectedBoss.name} - {selectedBoss.description}
              </h4>
          ...
          {!combatState.isVictory && !combatState.isDefeat && (
            <div className={styles.combatActions}>
              ...
              <button
                ...
                onClick={playerMagic}
                disabled={
                  !combatState.isPlayerTurn || combatState.playerMana < 20
                }
              >
                <Zap size={16} />
                Magic (20 MP)
              ...
              <button
                ...
                disabled={
                  !combatState.isPlayerTurn || combatState.playerMana < 50
                }
              >
                <Activity size={16} />
                Special (50 MP)
