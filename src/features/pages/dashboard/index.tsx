  ...
  const newsItems = [
    {
      ...
      description:
        'Explore the mysterious Shadowrealm with new bosses and legendary loot.',
      date: '2024-01-15',
      type: 'update',
      readMore: '/news',
    },
    {
      ...
      description:
        'Prepare for the annual Winter Festival with exclusive rewards and activities.',
      date: '2024-01-20',
      type: 'event',
      readMore: '/news',
    },
    {
      ...
      description:
        'Combat system improvements and skill adjustments based on community feedback.',
      date: '2024-01-18',
      type: 'patch',
      readMore: '/news',
    },
            ...
            {quickPages.map((page, index) => {
              ...
              return (
                <button
                  ...
                  style={
                    { '--accent-color': page.color } as React.CSSProperties
                  }
                >
