  ...
  const [enemies] = useState<Enemy[]>([
    {
      ...
      type: 'Goblin',
      rarity: 'common',
      rewards: { experience: 25, gold: 50, items: ['Goblin Tooth', 'Rusty Sword'] }
    },
    {
      id: 'orc1',
      name: 'Orc Berserker',
      ...
      type: 'Orc',
      rarity: 'uncommon',
      rewards: { experience: 60, gold: 120, items: ['Orc Axe', 'Berserker Helm'] }
    },
    {
      id: 'dragon1',
      name: 'Ancient Dragon',
      ...
      type: 'Dragon',
      rarity: 'legendary',
      rewards: { experience: 300, gold: 1000, items: ['Dragon Scale', 'Ancient Sword', 'Dragon Heart'] }
    }
  ]);
    ...
    <div className={styles.dungeon}>
      ...
      <div className={styles.scenerySection}>
        ...
        <div className={styles.sceneryDescription}>
          ...
          <p>
            Welcome to the legendary Shadowfang Dungeon, where only the bravest warriors dare to enter. 
            This ancient arena has witnessed countless battles between heroes and monsters. The walls 
            echo with the sounds of clashing steel and magical spells. Each chamber holds new challenges, 
            from lowly goblins to ancient dragons. Prove your worth and claim the treasures within!
          </p>
        </div>
      </div>
              ...
              {enemies.map((enemy) => (
                ...
                >
                  ...
                  <div className={styles.enemyInfo}>
                    ...
                    <p className={styles.enemyType}>Level {enemy.level} {enemy.type}</p>
              ...
              <div className={styles.combatantCard}>
                ...
                <div className={styles.combatInfo}>
                  ...
                  <div className={styles.manaBar}>
                    ...
                    <span className={styles.manaText}>{player.mana}/{player.maxMana}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={styles.combatant}>
              <div className={styles.combatantCard}>
                <div className={styles.combatAvatar}>
                  ...
                  />
                  <div className={styles.rarityBadge} style={{ 
                    backgroundColor: getRarityColor(selectedEnemy?.rarity || 'common'),
                ...
                <div className={styles.combatInfo}>
                  ...
                  <p className={styles.combatLevel}>Level {selectedEnemy?.level} {selectedEnemy?.type}</p>
                  <div className={styles.healthBar}>
                    <div className={styles.healthFill} style={{ 
                      width: `${((selectedEnemy?.health || 0) / (selectedEnemy?.maxHealth || 1)) * 100}%` 
                    }} />
                    <span className={styles.healthText}>{selectedEnemy?.health}/{selectedEnemy?.maxHealth}</span>
                  </div>
                </div>
              </div>
            </div>
