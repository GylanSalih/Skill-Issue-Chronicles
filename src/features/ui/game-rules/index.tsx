    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        ...
        <div className={styles.headerContent}>
          <h1>Game Rules</h1>
          <p>Please read and follow these rules to ensure a positive gaming experience for everyone.</p>
        </div>
      </div>
      ...
      <div className={styles.contactCard}>
        <div className={styles.contactContent}>
          ...
          <div className={styles.contactText}>
            ...
            <p>If you have questions about these rules or need to report a violation, please contact our moderation team through Discord or use the in-game report system.</p>
          </div>
        </div>
      </div>
    </div>
