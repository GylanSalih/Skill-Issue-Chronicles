...
export const CHARACTER_CLASSES: Record<string, CharacterClass> = {
  warrior: {
    ...
    image: '/assets/img/avatars/warrior.png',
    stats: {
      attack: 90,
      defense: 85,
      magic: 30,
  ...
  mage: {
    ...
    image: '/assets/img/avatars/magier.png',
    stats: {
      attack: 40,
      defense: 35,
      magic: 95,
  ...
  rogue: {
    id: 'rogue',
    name: 'Schurke',
    description: 'Schneller Kämpfer mit hoher Geschwindigkeit und kritischen Treffern',
    image: '/assets/img/avatars/schurke2.png',
    stats: {
      attack: 80,
      defense: 45,
      magic: 50,
  ...
  archer: {
    ...
    image: '/assets/img/avatars/elfe.png',
    stats: {
      attack: 75,
      defense: 50,
      magic: 40,
  ...
  healer: {
    ...
    image: '/assets/img/avatars/heilerin.png',
    stats: {
      attack: 35,
      defense: 60,
      magic: 90,
  ...
  berserker: {
    id: 'berserker',
    name: 'Berserker',
    description: 'Brutaler Kämpfer mit enormem Schaden aber niedriger Verteidigung',
    image: '/assets/img/avatars/berserk.png',
    stats: {
      attack: 100,
      defense: 40,
      magic: 20,
  ...
  paladin: {
    ...
    image: '/assets/img/avatars/paladin.png',
    stats: {
      attack: 70,
      defense: 80,
      magic: 70,
  ...
  assassin: {
    ...
    image: '/assets/img/avatars/assassine2.png',
    stats: {
      attack: 85,
      defense: 35,
      magic: 45,
  ...
  tinkerer: {
    ...
    image: '/assets/img/avatars/tuefftler.png',
    stats: {
      attack: 50,
      defense: 70,
      magic: 80,
  ...
  elementalist: {
    ...
    image: '/assets/img/avatars/elementarist.png',
    stats: {
      attack: 45,
      defense: 40,
      magic: 100,
